...
public class GameEngineTest {
    ...
    public void testParseWall() throws Exception {
        ...
        for(int x = 0; x < 8; x++) {
            for(int y = 0; y < 8; y++) {
                ...
                assertArrayEquals(GameEngine.parseWall(board,
    ...
    public void testExistsPathPlayer0() throws Exception {
        ...
        board.placeWall(new Square[] {board.getSquare("I-D"), 
                                      board.getSquare("II-D")});
        assertTrue(GameEngine.existsPath(p, board));
        board.placeWall(new Square[] {board.getSquare("III-D"), 
                                      board.getSquare("IV-D")});
        assertTrue(GameEngine.existsPath(p, board));
        board.placeWall(new Square[] {board.getSquare("V-D"), 
                                      board.getSquare("VI-D")});
        assertTrue(GameEngine.existsPath(p, board));
        board.placeWall(new Square[] {board.getSquare("VII-D"), 
                                      board.getSquare("VIII-D")});
        assertTrue(GameEngine.existsPath(p, board));
        board.placeWall(new Square[] {board.getSquare("VII-D"), 
                                      board.getSquare("VIII-D")});
        assertTrue(GameEngine.existsPath(p, board));
        board.placeWall(new Square[] {board.getSquare("VIII-D"), 
                                      board.getSquare("VIII-E")});
        assertTrue(GameEngine.existsPath(p, board));
        board.placeWall(new Square[] {board.getSquare("VIII-E"), 
                                      board.getSquare("IX-E")});
    ...
    public void testReachableAdjacentSquares() throws Exception {
        ...
        result[0] = board.getSquare(5,6);
        result[1] = board.getSquare(6,5);
        result[2] = board.getSquare(5,4);
        result[3] = board.getSquare(4,5);
        assertArrayEquals(result, GameEngine.reachableAdjacentSquares(board,
                                                board.getSquare(5,5)));
        result[0] = board.getSquare(1,6);
        result[1] = board.getSquare(2,5);
        result[2] = board.getSquare(1,4);
        result[3] = board.getSquare(0,5);
        assertArrayEquals(result, GameEngine.reachableAdjacentSquares(board,
                                                board.getSquare(1,5)));
        result = new Square[3];
        result[0] = board.getSquare(0,6);
        result[1] = board.getSquare(1,5);
        result[2] = board.getSquare(0,4);
        assertArrayEquals(result, GameEngine.reachableAdjacentSquares(board,
                                                board.getSquare(0,5)));
        result[0] = board.getSquare(8,6);
        result[1] = board.getSquare(8,4);
        result[2] = board.getSquare(7,5);
        assertArrayEquals(result, GameEngine.reachableAdjacentSquares(board,
                                                board.getSquare(8,5)));
        result[0] = board.getSquare(5,8);
        result[1] = board.getSquare(4,7);
        result[2] = board.getSquare(3,8);
        assertArrayEquals(result, GameEngine.reachableAdjacentSquares(board,
                                                board.getSquare(4,8)));
        result[0] = board.getSquare(4,1);
        result[1] = board.getSquare(5,0);
        result[2] = board.getSquare(3,0);
        assertArrayEquals(result, GameEngine.reachableAdjacentSquares(board,
                                                board.getSquare(4,0)));
        
        // walls
        board.placeWall(new Square[] {board.getSquare(4,0), 
                                      board.getSquare(4,1)});
        ...
        board.placeWall(new Square[] {board.getSquare(4,4), 
                                      board.getSquare(5,4)});
        // now we shouldn't be able to move to 4,5 aka V-F
        result = new Square[3];
        result[0] = board.getSquare(5,4);
        result[1] = board.getSquare(4,3);
        result[2] = board.getSquare(3,4);
        assertArrayEquals(result, GameEngine.reachableAdjacentSquares(board,
                                                board.getSquare(4,4)));
        ...
        result[2] = board.getSquare(3,5);
        assertArrayEquals(result, GameEngine.reachableAdjacentSquares(board,
                                                board.getSquare(4,5)));

        board.placeWall(new Square[] {board.getSquare(5,4), 
                                      board.getSquare(5,5)});
        result = new Square[2];
        ...
        board.placeWall(new Square[] {board.getSquare(5,3), 
                                      board.getSquare(6,3)});
        result = new Square[1];
        ...
        board.placeWall(new Square[] {board.getSquare(4,3), 
                                      board.getSquare(4,4)});
