...
public class PathTreeNodeTest{
	...
	node.setUp(new PathTreeNode(new Square(1,1)));
	...
	node.setDown(new PathTreeNode(new Square(1,1)));
	...
	node.setRight(new PathTreeNode(new Square(1,1)));
	...
	node.setLeft(new PathTreeNode(new Square(1,1)));
